...
public class section4E {
	/**
	 * This file allows us to reproduce simply the results from the section 4E
	...
	public static void buildDatasets() throws IOException{
		...
		for(String house : index_houses){
			...
			IOR.saveFile(arff_file, "generated_datasets/section4E_oneHourAhead", house+".arff");
	...
	public static void predict() throws Exception{
		...
		folder_dataset="generated_datasets/section4E_oneHourAhead";
		String output_folder="generated_results/section4E_oneHourAhead";
